...
<body>
    ...
    <div class="container">
        ...
        <div class="form-tag-section">
            <form id="addTagForm" action="${pageContext.request.contextPath}/playlist/addTag" method="post">
        ...
        <div class="table-section">
            <h2>Remove Tags</h2>
            <form id="deleteTagForm" action="${pageContext.request.contextPath}/playlist/deleteTags" method="post">
                <input type="hidden" name="plCode" value="${playlistCode}" />
                <table>
                    <thead>
                        <tr>
