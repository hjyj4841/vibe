	...
	function previewImage(event) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                const image = document.getElementById('createPlaylistImg');
...
<!--      http://192.168.10.6:8080/img/createplaylist_img/defaultCD.png -->
    <form action="createPlaylist" method="post" autocomplete="off" enctype="multipart/form-data">
     <img src="http://192.168.10.6:8080/playlistImg/${playlist.plImg}" style="width: 300px;" id="createPlaylistImg"/><br/>
      ...
      <input type="text" id="plTitle" name="plTitle" class="hidden-value" /><br />
	  <label>ADD IMG : </label><input type="file" id="plUrl" name="plUrl" accept="image/*" onchange="previewImage(event)" /><br />
