					...
					<div class="myTagBox">
						...
						<div class="searchMusicBox">
							<form class="mainSearchBox" onsubmit="return false;">
								<input type="text" placeholder="아티스트, 곡 제목 등 검색어를 입력하세요." id="musicName" onkeyup="if(event.keyCode=='13'){searchMusic();}" required>
							...
							<div id="resultContainer">
								<form class="addMusicform">
									...
									<input type="button" value="add Music" id="musicExistsInPlaylist" onclick="addMusicList()">
			...
			success: function(musicData){
				...
				$.each(musicData, function(index, music){
					let addMusicItem = 
						...
						'<i class="fa-solid fa-plus" onclick="addOneMusic(event)" data-code="' + music.id + '"></i>' +
						'</div>' +
						'</div>' +
						'</div>';
