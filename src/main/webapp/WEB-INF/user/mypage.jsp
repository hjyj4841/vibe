...
<body>
												...
												<div>
													<div class="etcUserBox">
														...
														<span class="etcUserNickname">
															${topPlaylist.user.userNickname } </span>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="etcDesc">
												...
												#${tag.tag.tagName } 
													...
													<div class="plLikeCon" data-code="${randomPlaylist.plCode}">
														...
														<span> Like </span> <span class="likeCount">${randomPlaylist.likeCount }</span>
													</div>
												</div>
												<div>
													<div class="etcUserBox">
														<img src="${randomPlaylist.user.userImg }"
															class="etcUserImg"> <span class="etcUserNickname">
															${randomPlaylist.user.userNickname } </span>
													</div>
												</div>
											</div>
										</div>
	...
	<script>
		...
		const plLikeBox = document.querySelectorAll(".plLikeCon");
